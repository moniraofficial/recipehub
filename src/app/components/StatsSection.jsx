    ...
    <section className="w-full bg-white dark:bg-slate-900 py-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div 
          ...
          className="w-full bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700/80 shadow-[0_10px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_15px_40px_rgba(0,0,0,0.2)] p-6 md:py-8 md:px-10 grid grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-4 items-center"
        >
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <motion.div 
                ...
                whileTap={{ scale: 0.95 }}
                className={`w-12 h-12 rounded-xl ${stat.bgColor} flex items-center justify-center shrink-0 cursor-pointer`}
              >
                {stat.icon}
              </motion.div>
