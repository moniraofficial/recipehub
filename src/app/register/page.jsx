...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Force direct clean session mount
      setTimeout(() => {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white dark:bg-slate-900 px-4 py-10 transition-colors duration-300">
      <div className="w-full max-w-[400px] space-y-7">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:border-emerald-500 text-slate-900 dark:text-white" 
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input 
                ...
                className="w-full pl-12 pr-12 py-3.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:border-emerald-500 text-slate-900 dark:text-white" 
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input 
                ...
                className="w-full pl-12 pr-12 py-3.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:border-emerald-500 text-slate-900 dark:text-white" 
              />
              <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-4 text-slate-400 focus:outline-none">
                {showConfirmPassword ? "👁️" : "🙈"}
              </button>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5 pt-1">
            ...
            <label htmlFor="terms" className="text-sm text-slate-500 dark:text-slate-400 cursor-pointer select-none">
              I agree to the <Link href="/terms" className="text-emerald-600 font-bold hover:underline">Terms of Service</Link>
            </label>
          </div>
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="w-full py-3.5 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition-colors shadow-sm disabled:bg-emerald-700/60"
          >
            {loading ? "Registering..." : "Register"}
          </button>
        </form>
        ...
        <button 
          ...
          className="w-full py-3.5 bg-white border border-slate-200 dark:bg-slate-800 dark:border-slate-700 rounded-xl font-bold text-sm text-slate-800 dark:text-slate-200 flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
        >
          Sign in with Google
        </button>
